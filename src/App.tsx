...
function App() {
  return (
    <div className="flex flex-col gap-6 mx-30">
      <h3 className="text-xl">Hello</h3>
      <p className="w-1/2 m-auto">
        I'm a Toronto based software engineer with 4.5+ years of building
        responsibe applications using React, TypeScript, and Ruby on Rails.
        Solving interesting problems from building AI tooling to help automate
        workflows, to optimizing high-traffic APIs for financial platforms.
      </p>
      <div>
        <h2 className="text-lg font-bold text-left mb-2">Experience</h2>
        <Experience
      ...
      <div className="[&>*]:text-left">
        ...
        <div className="flex">
          <div className="float-left w-14 h-14 mr-4">
            <img
          ...
          <div className="flex flex-col">
            <span className="">
              <a href="https://ontariotechu.ca/" className="!text-white/87">
                University of Ontario Institute of Technology
              </a>
            </span>
            <span>Honours, Bachelors of Science (BSc) in Computer Science Co-op</span>
          </div>
        </div>
      </div>

      <div>
        <h2 className="text-lg font-bold mb-2 text-left">Skills</h2>
      ...
      <div>
        <h2 className="text-xl font-bold m-5">Let's Connect!</h2>
